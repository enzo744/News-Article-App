    ...
    <div className="bg-gray-800 text-white py-8">
      <div className="container mx-auto px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          Ci impegniamo a fornire il miglior servizio e le migliori informazioni. La nostra missione è arricchire i documenti attraverso esperienze digitali eccezionali.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm">Phone: +39 1234 567 890</p>
        </div>
      </div>
